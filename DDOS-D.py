...
print(Fore.CYAN + "║" + Style.RESET_ALL + Fore.WHITE + "Author" + Style.RESET_ALL + "      :   " + Fore.WHITE + "CN Corp" + Style.RESET_ALL + Fore.CYAN + "                                   ║" + Style.RESET_ALL)
...
print(Fore.CYAN + "║" + Style.RESET_ALL + Fore.MAGENTA + "Tool" + Style.RESET_ALL + "        :   " + Fore.YELLOW + "DDOS Attack" + Style.RESET_ALL + Fore.CYAN + "                               ║" + Style.RESET_ALL)
print(Fore.CYAN + "╚══════════════════════════════════════════════════════════╝" + Style.RESET_ALL)
